...
import com.example.moviesexample.view.listeners.EndlessScrollCallback
...
class ListMoviesFragment: Fragment(), EndlessScrollCallback {
    ...
    private fun buildRecyclerView() {
        ...
        binding.movieListRecyclerView.addOnScrollListener(
            EndlessScrollListener(layoutManager,this, AndroidLogger())
        )
    }
